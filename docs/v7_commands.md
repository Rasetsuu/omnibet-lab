...
cargo run --bin omnibet-pack -- head ../data_packs/football_core_v1 matches_norm 5
```

If `cargo` is missing in the environment, this package still contains the source and docs.
