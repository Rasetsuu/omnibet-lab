    ...
    match load_minipack(&args.root) {
        Ok(report) => {
            ...
            let mut command_result = json!({
                ...
                "desktop_out": args.desktop_out.clone(),
                "storage_manifest_out": args.storage_manifest_out.clone(),
                "history_dir": args.history_dir.clone(),
                "history_index_out": args.history_index_out.clone(),
                "trust_status": report.trust_status.clone(),
                "validated_paper": report.validated_paper,
