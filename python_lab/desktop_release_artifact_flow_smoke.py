...
def build_report(root: Path) -> Dict[str, Any]:
    ...
    checks = {
        ...
        "readme_user_path": "README_RUN.txt" in workflow and archive_expectations.get("windows_app_name") in workflow and "run-omnibet-lab-linux.sh" in workflow,
        ...
        "release_notes_download_path": "Download the archive for your platform" in workflow and "Windows: `OmniBet-Lab.exe`" in workflow and "Linux: `./run-omnibet-lab-linux.sh`" in workflow,
