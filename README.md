...
This MVP is paper-only and sample-first. It exposes fixture selection, market prediction rows, trust blockers, movement preview, paper watchlist/ledger previews, source freshness badges, and a disabled bilet-builder placeholder.
